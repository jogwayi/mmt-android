...
public class DocsApi {
  ...
  * 
   * @return void
  */
  public void readme () throws TimeoutException, ExecutionException, InterruptedException, ApiException {
  ...
  */
  public void readme (final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
