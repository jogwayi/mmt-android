...
import util.mymosttrusted.api.request.GetRequest;
import util.mymosttrusted.api.request.PostRequest;
import util.mymosttrusted.api.request.PutRequest;
import util.mymosttrusted.api.request.DeleteRequest;
import util.mymosttrusted.api.request.PatchRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
    ...
    INSTANCE.authentications.put("ApiKeyAuth", new HttpBasicAuth());
